...
def computer_turn(displayGrid,coordGrid,row1,random_num3,random_num4,col1,row2,col2,row_list,col_list):
    ...
    while True:
        ...
        while True:
                ...
                if satisfied.lower() == "y":
                    ...
                    displayGrid[row1][col1] = " "
                    displayGrid[row2][col2] = " "
                    coordGrid[row1][col1] = " "
                    coordGrid[row2][col2] = " "
