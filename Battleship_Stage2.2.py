...
def player_shoot(computerDisplayGrid, computerCoordGrid, col_list, row_list):
    while True:
...
# Gianna
def computer_shoot(playerDisplayGrid, playerCoordGrid, row1, col1, row2, col2, row3, col3, row4, col4, row_list, col_list, random_num3, random_num4):
    ...
    X = "x"
    playerDisplayGrid[row][col] = f"{Fore.LIGHTMAGENTA_EX}{X}{Fore.BLUE}"
    playerCoordGrid[row][col] = X
    if playerCoordGrid[row1][col1] == X:
        playerDisplayGrid [row1][col1] = f"{Fore.LIGHTBLACK_EX}{X}{Fore.BLUE}"
    if playerCoordGrid[row2][col2] == X:
        playerDisplayGrid [row2][col2] = f"{Fore.LIGHTBLACK_EX}{X}{Fore.BLUE}"
    if playerCoordGrid[row3][col3] == X:
        playerDisplayGrid [row3][col3] = f"{Fore.LIGHTBLACK_EX}{X}{Fore.BLUE}"
    if playerCoordGrid[row4][col4] == X:
        playerDisplayGrid [row4][col4] = f"{Fore.LIGHTBLACK_EX}{X}{Fore.BLUE}"
    return (playerDisplayGrid, playerCoordGrid, X)
...
def player_turn(computerDisplayGrid, computerCoordGrid, row1, col1, row2, col2, row3, col3, row4, col4, random_num3, random_num4, row_list, col_list):
    ...
    player_shoot(computerDisplayGrid, computerCoordGrid, col_list, row_list)
