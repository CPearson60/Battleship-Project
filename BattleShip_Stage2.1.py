...
def shipAnimation_hit():
    ...
    print(Style.RESET_ALL+f"   |___|__|____/           __     ")                           
    print(Style.RESET_ALL+f"_  |____________|         |  |==                    8--->>>>        ")                                                                           
    print(Style.RESET_ALL+f"___]_|__|____[___\________/__\_ .7")                   
    print(Style.RESET_ALL+f"                           BB-61/")               
    print(Style.RESET_ALL+f"_______________________________/")
    time.sleep(.5)
    os.system('cls' if os.name == 'nt' else 'clear')
    print(" ")
    print(Style.RESET_ALL+f"_        ")
    print(Style.RESET_ALL+f"/           __     ")                           
    print(Style.RESET_ALL+f"_|         |  |==                         8--->>>>        ")                                                                           
    print(Style.RESET_ALL+f"__[________/__\_ .7")                   
    print(Style.RESET_ALL+f"            BB-61/")               
    print(Style.RESET_ALL+f"________________/")
    time.sleep(.5)
    os.system('cls' if os.name == 'nt' else 'clear')
